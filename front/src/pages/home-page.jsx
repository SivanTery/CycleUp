    ...
    return (
            <section className='home main-layout'>
                <div className='nav-card-wrapper'>
                    ...
                    <NavLink to="/search-garbage">חיפוש פח קרוב</NavLink>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="50px" height="50px" viewBox="0 0 96 96" data-name="Your Icons" id="Your_Icons"><title/>
